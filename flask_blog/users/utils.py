...
def save_picture(form_picture):
    ...
    # TODO 10. Что такое form_picture? От куда у form_picture атрибут filename? И зачем мы его разбиваем?
...
def send_reset_email(user):
    ...
    # TODO 17 Как здесь _external связано с _external в генерации токена
