...
def register():
    ...
    # TODO 11 От куда данные в форму попадают? Где в шаблоне отправка на ендпоинт?
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password,
                                               form.password.data):
            # TODO 14 Что такое remember
            login_user(user, remember=form.remember.data)

            # TODO 15 Что такое next и как здесь запоминается страница
...
def account():
    ...
    if form.validate_on_submit():
        ...
        # TODO Как save_picture связан с БД?
        db.session.commit()
        ...
        # TODO Зачем мы page а пагинацию передаем?
